import {
    ...
    postLoginVendor, 
    postNewVendor, 
    postResetVendorEmail, 
    postResetVendorPhone, 
    postResetVendorPwd, 
    postUpdateVendorProfile
} from "../../services/vendor/vendor.js";
...
export async function REGISTER_VENDOR(req, res) {
    try {
        ...
        res.status(201).json({ success: true, data: new_vendor });
    } catch (error) {
        res.status(400).json({ success: false, message: error.message });
    }
}
...
export async function LOGIN_VENDOR(req, res) {
    try {
        ...
        res.status(201).json({ success: true, data: login_vendor });
    } catch (error) {
        res.status(400).json({ success: false, message: error.message });
    }
}
...
export async function RESET_VENDOR_EMAIL(req, res) {
    try {
        ...
        res.status(201).json({ success: true, data: reset_vendor_email });
    } catch (error) {
        res.status(400).json({ success: false, message: error.message });
    }
}
...
export async function RESET_VENDOR_PHONE(req, res) {
    try {
        ...
        res.status(201).json({ success: true, data: reset_vendor_phone });
    } catch (error) {
        res.status(400).json({ success: false, message: error.message });
    }
}
...
export async function UPDATE_VENDOR_PROFILE(req, res) {
    try {
        ...
        res.status(201).json({ success: true, data: update_vendor_profile });
    } catch (error) {
        res.status(400).json({ success: false, message: error.message });
    }
}
