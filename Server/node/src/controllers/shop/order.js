...
export async function POST_NEW_ORDER(req, res) {
    try {
        ...
        res.status(201).json({ success: true, data: new_order });
    } catch (error) {
        res.status(400).json({ success: false, message: error.message });
    }
}
...
export async function REMOVE_ORDER(req, res) {
    try {
        ...
        res.status(201).json({ success: true, data: remove_order });
    } catch (error) {
        res.status(400).json({ success: false, message: error.message });
    }
}
...
export async function CONFIRM_ORDER(req, res) {
    try {
        ...
        res.status(201).json({ success: true, data: confirm_order });
    } catch (error) {
        res.status(400).json({ success: false, message: error.message });
    }
}
...
export async function UPDATE_ORDER(req, res) {
    try {
        ...
        res.status(201).json({ success: true, data: update_order });
    } catch (error) {
        res.status(400).json({ success: false, message: error.message });
    }
}