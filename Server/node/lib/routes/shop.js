import { GET_CUSTOMER, REGISTER_CUSTOMER, LOGIN_CUSTOMER, RESET_CUSTOMER_EMAIL, RESET_CUSTOMER_PHONE, UPDATE_CUSTOMER_PROFILE, RESET_PWD, CONFIRM_EMAIL, VERIFY_TOKEN, ALTER_PWD } from "../controllers/shop/customer.js";
import { GET_FAVOURITE, GET_FAVOURITES, POST_FAVOURITE, DELETE_FAVOURITE } from "../controllers/shop/favourite.js";
import { GET_ORDER, GET_ORDERS, POST_NEW_ORDER, CANCEL_ORDER, REMOVE_ORDER, CONFIRM_ORDER, UPDATE_ORDER } from "../controllers/shop/order.js";
import { GET_PRODUCT, GET_PRODUCTS, GET_PRODUCTS_TYPE, GET_PRODUCT_THUMBNAIL, GET_SEARCH, POST_PRODUCT_VIEW, UPDATE_PRODUCT_VIEW_FOR_UNKNOWN_CUSTOMER } from "../controllers/shop/product.js";
import { GET_REFUND, GET_REFUNDS, CREATE_REFUND, CANCEL_REFUND, REMOVE_REFUND, CONFIRM_REFUND } from "../controllers/shop/refund.js";
import { GET_SHOP_OWNER, GET_SHOP_REVIEWS, GET_SHOP_DETAILS, GET_SHOP_CONTENT, POST_NEW_SHOP_REVIEW
// POST_NEW_SHOP_VISIT
...
CUSTOMER_ROUTE.post('/confirm-email', parser, CONFIRM_EMAIL);
