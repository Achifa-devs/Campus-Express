...
import menuSvg from '../../../public/menu-alt-01-svgrepo-com.svg'

import filterSvg from '../../../public/filter-edit-svgrepo-com.svg'
...
import cartSvg from '../../../public/cart-shopping-fast-svgrepo-com.svg'
...
const Header = ({
  ...
  useEffect(() => {
    if(window.location.pathname.split('/').splice(-1)[0] === 'product'){
      setWidth('100%')
    }else{
  ...
  return ( 
    <>
      ...
      <div className="buyer-header" style={{position: 'sticky', top: '0', zIndex: '10000'}}>
        ...
        <img src={img} style={{height: screenWidth > 760 ? '50px' : '50px', width: screenWidth > 760 ? '50px' : '50px', borderRadius: '5px'}}  alt="" />
        {
        ...
        {
          screenWidth < 760 && location.pathname.split('/').splice(-1)[0]==='order-tracking'
          ? 
