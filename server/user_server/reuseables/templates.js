...
let newItem = (category,price,title)=> {
    return(`
    ...
    <body>
        <div class="container">
            ...
            <p class="mailAdsCnt">
                We are delighted to inform you that your item has been successfully published on Campus Express and is now visible to our campus community of buyers. Congratulations on reaching this milestone!
            </p>
            ...
            <div>If you have any questions or need further assistance, please do not hesitate to contact our support team at support@campusexpress.com. We are here to help you succeed.</div>
            <div>Thank you for choosing Campus Express as your selling platform. We look forward to seeing your business thrive!</div>
        </div>
        <footer>
            <div class="footer">
                Sent with ❤️ from Campus Express.
