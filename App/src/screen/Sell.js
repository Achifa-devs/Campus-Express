...
import SellModal from '../reusables/SellModal';
import LoginReminder from '../reusables/LoginReminder';
...
const ShopScreen = () => {
  ...
  const renderAdItem = ({ item }) => (
    ...
    <TouchableOpacity 
      style={styles.adCard}
      onPress={() => navigation.navigate('metrics', {data: item})}
    >
  ...
  if(!user){
    return(
      <>
      { !user && 
        <LoginReminder text="Sign in to access your personalized dashboard" style={{ backgroundColor: '#2196F3' }} />
      }
      </>
    )
  }
          ...
          <View style={{ padding: 5, width: '100%' }}>
            {[
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  toggleModal();
                  navigation.navigate('create', { update: false, purpose: item.purpose });
                }}
      ...
      >
        ...
        <View style={styles.adsSection}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity onPress={e => navigation.navigate('inventory', {data: userAds})}>
