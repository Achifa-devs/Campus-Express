        ...
        if(validation.current){
            ...
            .then(async(result) => {
                ...
                if(response.success){
                    ...
                    if(check){
                        ...
                        div.innerHTML = response.message || response.Mssg
            ...
            .catch((err) => {
                ...
                if(check){
                    ...
                    div.style.display = 'table'
                    div.style.margin = '0 auto'
                    div.innerHTML = err.message || err.Mssg
                    document.querySelector('.err-cnt').append(div)
       ...
       <div className="seller-login-cnt" >
            ...
            <section className="shadow" style={{
                ...
                <div style={{textAlign: 'center'}} onClick={e => window.location.href=('/password-recovery')}>
                    <small style={{cursor: 'pointer', color: '#FFA500', fontWeight: '400'}}>Recover Forgotten Password Here</small>
                </div>
