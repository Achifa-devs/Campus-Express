      ...
      <div className="seller-profile">
        <div className="seller-profile-cnt">
            ...
            <div className="top">
                <section>
                    <h3>
                    Welcome to dorm deals! Let’s take your shop live!
                    </h3>
        ...
        <>
            ...
            <div className="btm">
                <section>
                    ...
                    <h6>Manage your shop on dorm deals from below</h6>
                </section>
                ...
                <section>
                    ...
                    <h6>Choose the contact preference for communications from dorm deals. We ll send communications and contact you on the details below</h6>
                </section>
