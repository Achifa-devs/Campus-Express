...
import '@/app/store/order-tracking/styles/xx-large.css'
import '@/app/store/order-tracking/styles/x-large.css'
import '@/app/store/order-tracking/styles/large.css'
import '@/app/store/order-tracking/styles/medium.css'
import '@/app/store/order-tracking/styles/small.css'
                        ...
                        <div className="order-details-btm" style={{display: 'flex', padding: '8px', alignItems: 'flex-start', flexDirection: screenWidth > 760 ? 'row' : 'column', justifyContent: 'space-between', height: 'auto',width: '100%', backgroundColor: '#fff'}}>
                            ...
                            <div style={{border: '1px solid #efefef', padding: '10px'}}>Delivery Details</div>
                                ...
                                <div>
                                    <h6>Payment Method</h6>
                                    <ul style={{padding: '6px'}}>
                                    <li style={{fontSize: 'small'}}>dorm deals Payment <b>(Powered By Paystack Titan)</b></li>
                                    </ul>
                                </div>
