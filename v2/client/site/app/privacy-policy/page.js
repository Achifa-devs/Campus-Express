    ...
    <div>
         <header>
            <img src={logo.src} style={{ height: '100px', width: '100px' }} alt="" />
              ...
              <h1 style={{ color: '#fff', fontSize: '4vh', fontWeight: '500' }}>dorm deals Privacy policy</h1>
              
              <small className='overview'>Thank you for using dorm deals Nigeria, an online platform dedicated to facilitating buying and selling within the campus community. This Privacy Policy outlines how we collect, use, disclose, and protect your personal information.</small>
        </header>
        ...
        <div>
            ...
            <article>
                <p>
                    ...
                    By using dorm deals Nigeria, you agree to the terms outlined in this Privacy Policy.
                </p>
            </article>
