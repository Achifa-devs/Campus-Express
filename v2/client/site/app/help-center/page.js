  ...
  return (
    <div>
      <header>
        ...
        <h1 style={{color: '#fff', fontSize: '4vh', fontWeight:  '500'}}>dorm deals Help Center</h1>
      </header>
      <section >
        ...
        <ul className='overview'>
          <li className='overview-links'><a href="#one">How to shop on dorm deals?</a></li>
          <li className='overview-links'><a href="#two">How to sell on dorm deals?</a></li>
          <li className='overview-links'><a href="#three">Delivery options and timelines</a></li>
          <li className='overview-links'><a href="#four">How to return a product on dorm deals?</a></li>
      ...
      <section className='content'>
        ...
        <section id='four'>
          <div className="sub-header">
            How to return a product on dorm deals?
          </div>
          <article>
