  ...
  return (
    <>
        <main>
            ...
            <div >
                <h6 style={{padding:'10px', margin: '0', borderBottom: '1px solid #efefef', height: '50px', width: '100%', background: '#fff', fontWeight: '600', display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>General Terms and Conditions of Use of the Marketplace for Buyers and Sellers</h6>

                <ol style={{listStyleType: 'number', padding: '20px', background: '#fff'}}>
                    <section style={{padding: '20px'}}>
                        <li><h6>Introduction</h6></li>

                        <div>
                            <ol style={{listStyleType: 'unset', background: '#fff'}} type='a'>
                                <li>
                                    “dorm deals” is the trading name for the U-COMMERCE LIMITED SUB-SIDIARY(IES) companies. dorm deals company (“dorm deals” or “we”) operates an e-commerce platform consisting of a website and mobile application (“marketplace”) together with payment infrastructure for the sale and purchase of consumer products and services (“products”) in its allocated territory.
                                </li>
                                ...
                                <li>If you use our marketplace in the course of a business or other organizational project then by so doing you:</li>
                                
                                <ul style={{listStyleType: 'unset', background: '#fff'}}>
                                    <li>Confirm that you have obtained the necessary authority to agree to these general terms and conditions</li>
                                    <li>Bind both yourself and the person company or other legal entity that operates that business or organizational project to these general terms and conditions</li>
                    ...
                    <section style={{padding: '20px'}}>
                        <li><h6>Registration and account</h6></li>
                            ...
                            <ol style={{listStyleType: 'unset', background: '#fff'}} type='a'>
                                ...
                                <ol style={{listStyleType: 'unset'}} type='a'>
                                    <li>
                                        ...
                                        Notify us in writing immediately (using our contact details provided at section 26) if you become aware of any disclosure of your password
                                    </li>
                    ...
                    <section style={{padding: '20px'}}>
                        <li><h6>Terms and conditions of sale</h6></li>
                        ...
                        <ol style={{listStyleType: 'unset'}} type='a'>
                            ...
                            <li>You acknowledge and agree that:</li>
                             <ol style={{listStyleType: 'unset'}} type='a'>
                                ...
                                <li>We shall accept binding sales on behalf of sellers but (unless dorm deals is indicated as the seller) dorm deals is not a party to the transaction between the seller and the buyer; and</li>
                            ...
                            <ol style={{listStyleType: 'unset'}} type='a'>
                                ...
                                <li>delivery charges packaging charges handling charges administrative charges insurance costs other ancillary costs and charges where applicable will only be payable by the buyer if this is expressly and clearly stated in the product listing; and delivery of digital products may be made electronically;</li>
                    ...
                    <section style={{padding: '20px'}}>
                        <li><h6>Returns and refunds</h6></li>
                        ...
                        <ol style={{listStyleType: 'unset'}} type='a'>
                            ...
                            <li>Returned products shall be accepted and refunds issued by dorm deals acting for and on behalf of the seller. Notwithstanding paragraphs 4.1 and 4.2 above in respect of digital products or services and fresh food dorm deals shall issue refunds in respect of failures in delivery only. Refunds of payment for such products for any other reasons shall be subject to the seller’s terms and conditions of sale.</li>
                    ...
                    <section style={{padding: '20px'}}>
                        ...
                        <ol style={{listStyleType: 'unset'}} type='a'>
                            <li>Promotions and competitions run by dorm deals and/or other promoters shall be managed in accordance with the Promotions Terms and Conditions. You can view each Promotion&apos;s terms and conditions on our website</li>
                        </ol>
                    </section>
                    ...
                    <section style={{padding: '20px'}}>
                        <li><h6>Rules about your content</h6></li>
                        ...
                        <ol style={{listStyleType: 'unset'}} type='a'>
                            ...
                            <li>Your content must be appropriate civil and tasteful and accord with generally accepted standards of etiquette and behaviour on the internet and must not:</li>
                            <ol style={{listStyleType: 'unset'}} type='a'>
                            ...
                            <li>You must not interfere with a transaction by</li>
                            <ol style={{listStyleType: 'unset'}} type='a'>
                            ...
                            <li>If you learn of any unlawful material or activity on our marketplace or any material or activity that breaches these general terms and conditions you may inform us by contacting us as provided at section</li>
                        </ol>
                    ...
                    <section style={{padding: '20px'}}>
                        <li><h6>Our rights to use your content</h6></li>

                        <ol style={{listStyleType: 'unset'}} type='a'>
                            <li>You grant to us a worldwide irrevocable non-exclusive royalty-free license to use reproduce store adapt publish translate and distribute your content on our marketplace and across our marketing channels and any existing or future media.</li>

                            <li>You grant to us the right to sub-license the rights licensed under section 9.1</li>

                            <li>You grant to us the right to bring an action for infringement of the rights licensed under section 9.1</li>
                    ...
                    <section style={{padding: '20px'}}>
                        ...
                        <ol style={{listStyleType: 'unset'}} type='a'>
                            <li>In this section 10 words “marketplace” and website” shall be used interchangeably to refer to dorm deals’s websites and mobile applications.</li>
                            ...
                            <li>Except as expressly permitted by section 10.2 or the other provisions of these general terms and conditions you must not download any material from our website or save any such material to your computer.</li>
                            ...
                            <li>Notwithstanding section 10.6 you may forward links to products on our website and redistribute our newsletter and promotional materials in print and electronic form to any person.</li>
                    ...
                    <section style={{padding: '20px'}}>
                        <li><h6>Copyright and trademarks</h6></li>
                        ...
                        <ol style={{listStyleType: 'unset'}} type='a'>
                            ...
                            <li>dorm deals’s logos and our other registered and unregistered trademarks are trademarks belonging to us; we give no permission for the use of these trademarks and such use may constitute an infringement of our rights.</li>
                    ...
                    <section style={{padding: '20px'}}>
                        ...
                        <ol style={{listStyleType: 'unset'}} type='a'>
                            <li>Buyers agree to processing of their personal data in accordance with the terms of dorm deals’s Privacy and Cookie Notice.</li>

                            <li>dorm deals shall process all personal data obtained through the marketplace and related services in accordance with the terms of our Privacy and Cookie Notice and Privacy Policy.</li>

                            <li>Sellers shall be directly responsible to buyers for any misuse of their personal data and dorm deals shall bear no liability to buyers in respect of any misuse by sellers of their personal data.</li>
                        </ol>
                    </section>
                    ...
                    <section style={{padding: '20px'}}>
                        <li><h6>dorm deals role as a marketplace</h6></li>
                    ...
                    <section style={{padding: '20px'}}>
                        <li><h6>Limitations and exclusions of liability</h6></li>
                        ...
                        <ol style={{listStyleType: 'unset'}} type='a'>
                            ...
                            <ol style={{listStyleType: 'unset'}} type='a'>
                                ...
                                <li>dorm deals facilitates a marketplace for buyers and third party sellers or dorm deals where dorm deals is the seller of a product;</li>
                                
                                <li>The relevant seller of the product (whether dorm deals is the seller or whether it is a third party seller) shall at all times remain exclusively liable for the products they sell on the marketplace; and</li>
                                
                                <li>In the event that there is an issue arising from the purchase of a product on the marketplace the buyer should seek recourse from the relevant seller of the product by following the process set out in dorm deals&apos;s Dispute Resolution Policy</li>
                            </ol>


                            <li>We commit to ensure that dorm deals or third party sellers as applicable submit information relating to their products on the marketplace that is complete accurate and up to date and pursuant thereto:</li>
                    ...
                    <section style={{padding: '20px'}}>
                        <li><h6>Breaches of these general terms and conditions</h6></li>
                        ...
                        <ol style={{listStyleType: 'unset'}} type='a'>
                            ...
                            <li>If you breach these general terms and conditions or if we reasonably suspect that you have breached these general terms and conditions or any dorm deals codes policies or guidelines in any way we may:</li>
                    ...
                    <section style={{padding: '20px'}}>
                        ...
                        <ol style={{listStyleType: 'unset'}} type='a'>
                            <li>Should these general terms and conditions the seller terms and conditions and the dorm deals codes policies and guidelines be in conflict these terms and conditions the seller terms and conditions and the dorm deals codes policies and guidelines shall prevail in the order here stated.</li>
                        </ol>
                    </section>
                    ...
                    <section style={{padding: '20px'}}>
                        ...
                        <ol style={{listStyleType: 'unset'}} type='a'>
                            <li>We may revise these general terms and conditions the seller terms and conditions and the dorm deals codes policies and guidelines from time to time.</li>
                    ...
                    <section style={{padding: '20px'}}>
                        <li><h6>Third party rights</h6></li>
                    ...
                    <section style={{padding: '20px'}}>
                        <li><h6>Law and jurisdiction</h6></li>
                    ...
                    <section style={{padding: '20px'}}>
                        <li><h6>Our company details and notices</h6></li>

                        <ol style={{listStyleType: 'unset'}} type='a'>
                            <li>You can contact us by using the contact details listed in Appendix 1.</li>

                            <li>You may contact our sellers for after-sales queries including any disputes by requesting their contact details from the dorm deals in accordance with the Dispute Resolution Policy pursuant to which dorm deals shall be obliged to ensure that the seller is clearly identifiable.</li>
