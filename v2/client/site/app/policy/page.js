    ...
    <div>
         <header>
            <img src={logo.src} style={{ height: '100px', width: '100px' }} alt="" />
              ...
              <h1 style={{ color: '#fff', fontSize: '4vh', fontWeight: '500' }}>dorm deals Policies</h1>
              
              <small className='overview'>Welcome to dorm deals Nigeria - your trusted campus marketplace. Below you&apos;ll find all our policies designed to create a safe, fair, and transparent trading environment for our campus community.</small>
        </header>
        ...
        <div>
            ...
            <article>
                ...
                <p>
                    3. Platform Usage:
                    - dorm deals provides the platform but isn&apos;t involved in individual transactions
            ...
            <article>
                ...
                <p>
                    3. Final Decision:
                    - dorm deals&apos;s decision is final in all disputes
            ...
            <article>
                ...
                <p>
                    ...
                    By using dorm deals Nigeria, you agree to all the policies outlined above.
                </p>
            </article>
