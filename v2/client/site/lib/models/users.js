...
export async function truncateUser({ user_id }) {
  // Code here
  return null;
}

export async function updateUserPhotoById({ photo, user_id }) {
...
export async function createNewToken({ token, date, user_id }) {
...
export async function countToken({ token, user_id }) {
  const { rows } = await pool.query(
...
export async function updateUserPhoneById({ user_id, phone }) {
  const result = await pool.query(
...
export async function updateUserEmailById({ user_id, email }) {
  const result = await pool.query(
...
export async function updateUserProfileById({ user_id, fname, lname, gender }) {
  const result = await pool.query(
...
export async function updateUserPasswordById({ user_id, password }) {
  const { rows } = await pool.query(
...
export async function updateUserFcm({ fcm, user_id }) {
  const result = await pool.query(
