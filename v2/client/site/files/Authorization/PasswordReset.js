...
const PasswordReset = () => {
    ...
    return ( 
        <>
            ...
            <div className="password-reset shadow-sm" style={{background: '#FFA500', bottom: '0', display: 'flex', flexDirection: 'column', position: 'absolute', height: 'calc(100vh - 60px)', width: '100%'}}>
                {
                    isTokenVerified
                    ?
                    <>
