...
export default function Faq() {
    ...
    let list = useRef([
        ...
        {
            title: 'dorm deals Payment',
            uri: 'Understand dorm deals Payment',
            description: 'Gain a comprehensive understanding of the various payment options available on dorm deals. Learn how to securely make payments and manage your transactions with ease and confidence.',
        ...
        {
            title: 'Security On dorm deals',
            uri: '',
            description: 'Explore the extensive security measures we have in place on dorm deals. Learn about our escrow services designed to prevent fraud and ensure a safe shopping experience for all users.',
        ...
        
        {
            ...
            uri: '',
            description: 'Get detailed information about the billing methods supported by dorm deals. Understand how our billing system works to ensure transparent and accurate transactions for your purchases.',
        ...
        
        {
            ...
            uri: '',
            description: 'Learn how to complete the payment process for your orders on dorm deals. Follow our step-by-step guide to make secure payments and confirm your purchases effortlessly.',
        ...
        
        {
            ...
            uri: '',
            description: 'Understand the process to cancel an order on dorm deals. Learn about the conditions under which you can cancel your order and the steps to follow for a successful cancellation.',
      ...
      <BuyerLayout>
        ...
        }}>
        {
            list.current.map(item => 
                <div className="cols">
                    <div className="card shadow-sm" style={{height: 'auto', marginBottom: '10px', borderRadius: '10px', background: '#FFF6E0', color: '#FFA500'}}>
