                    ...
                    <div className="cols" >
                            <div className="card" key={index} style={{height: 'fit-content', marginBottom: '10x', flexShrink: '0', width: '200px', borderRadius: '10px'}}>
                                ...
                                <div className="card-body">
                                    ...
                                    {/* <div onClick={e => navigate(`/product?product_id=${item.product_id}`)} style={{display: 'flex',background: '#fff', color: '#FFA500',  alignItems: 'center', justifyContent: 'left', padding: '0'}}>
