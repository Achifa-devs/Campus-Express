      ...
      <section style={{fontWeight: '500', display: 'flex', flexDirection: 'column', alignItems: 'flex-end', padding: '10px', position: 'relative', width: '100%',}}>
            ...
            <ul>
                <li onClick={e => {
                    ...
                    window.open(`https://www.facebook.com/sharer/sharer.php?u=Check out this product on dorm deals ${encodeURIComponent(window.location.href)}`, '_blank');
                ...
                <li onClick={e => {
                    // const url = window.location.href;
                    const twitterUrl = `https://twitter.com/intent/tweet?&text=Check out this product on dorm deals ${encodeURIComponent(window.location.href)}`;
                ...
                <li onClick={async e => {
                    const whatsappUrl = `whatsapp://send?text=Check out this product on dorm deals ${encodeURIComponent(window.location.href)}`;
