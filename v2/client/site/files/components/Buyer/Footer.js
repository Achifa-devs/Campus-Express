    ...
    <footer style={footerStyles}>
      <div style={topFooter}>
        ...
        <section style={{display: 'flex', width: screenWidth > 760 ? '25%' : '100%', justifyContent:  screenWidth > 760 ? 'flex-start' : 'center', alignItems: 'center', flexDirection: 'row', marginBottom: screenWidth > 760 ? '0px' : '10px'}}>
          ...
          <small style={{fontSize: '3.5vh'}}><b>dorm deals</b></small>
        </section>
        ...
        <section style={{display: 'flex', width: screenWidth > 760 ? '25%' : '100%', justifyContent: screenWidth > 760 ? 'flex-start' : 'center', alignItems: screenWidth > 760 ? 'flex-start' : 'center', flexDirection: 'column'}}>
          ...
          <div className="input-cnt" style={{display: 'flex', justifyContent: 'flex-start', alignItems: 'center', flexDirection: 'row', backgroundColor: 'inherit'}}>
            ...
            <label style={{padding: '0', margin: '0'}} htmlFor="terms">
              <small style={{fontSize: 'x-small', textAlign: 'left', display: 'flex', justifyContent: 'flex-start', alignItems: 'flex-start', flexDirection: 'row', padding: '0', margin: '0'}}>I agree to dorm deals’s Privacy and Cookie Policy. You can unsubscribe from newsletters at any time.</small>
            </label>
          </div> 
        ...
        <section style={{display: 'flex', width: screenWidth > 760 ? '25%' : '100%', justifyContent: 'flex-start', alignItems: 'flex-start', flexDirection: 'column'}}>
          <div style={{display: 'flex', width: '100%', justifyContent: 'space-between', alignItems: 'flex-start', flexDirection: 'row', marginBottom: '0px'}}>
            ...
            <div style={{display: 'flex', width: '100%', justifyContent: 'flex-start', alignItems: 'flex-start', flexDirection: 'column', marginBottom: '10px'}}>
              <small><b>Download dorm deals Free App</b></small>
      ...
      <div style={containerStyles}>
        ...
        {/* Quick Links Section */}
        <div style={sectionStyles}>
          <h4 style={sectionTitleStyles}>About dorm deals</h4>
          <ul style={listStyles}>
            ...
            <li style={listItemStyles}><a href="/" style={linkStyles}>dorm deals Return Policy</a></li>
            <li style={listItemStyles}><a href="/" style={linkStyles}>dorm deals Payment Information Guidelines</a></li>
        ...
        <div style={sectionStyles}>
          <h4 style={sectionTitleStyles}>Make Money On dorm deals</h4>
          <ul style={listStyles}>
            <li style={listItemStyles}><a href="/vendor/shop" style={linkStyles}>Sell On dorm deals</a></li>
            {/* <li style={listItemStyles}><a href="/" style={linkStyles}>Become A dorm deals Affiliate</a></li> */}
          </ul>
        </div>

        <div style={sectionStyles}>
          <h4 style={sectionTitleStyles}>dorm deals International</h4>
          <ul style={listStyles}>
            <li style={listItemStyles}><a href="/" style={linkStyles}>dorm deals Nigeria</a></li>
            {/* <li style={listItemStyles}><a href="/" style={linkStyles}>dorm deals Ghana</a></li>
            <li style={listItemStyles}><a href="/" style={linkStyles}>dorm deals Niger</a></li>
            <li style={listItemStyles}><a href="/" style={linkStyles}>dorm deals Cameroun</a></li>
            <li style={listItemStyles}><a href="/" style={linkStyles}>dorm deals Senegal</a></li> */}
          </ul>
      ...
      <div style={bottomFooterStyles}>
        <p style={{ margin: 0, color: '#fff'}}>&copy; {new Date().getUTCFullYear()} dorm deals. All Rights Reserved.</p>
      </div>
    </footer>
  );
};
