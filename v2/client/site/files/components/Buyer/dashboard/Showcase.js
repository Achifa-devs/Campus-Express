        ...
        <section style={{marginBottom: 10}}> 
            <div style={{ fontFamily: 'Arial, sans-serif', color: '#333', lineHeight: '1.6', margin: '0', padding: '0', background: '#fff', borderRadius: '5px'}}>
                <header style={headerStyle}>
                    <h1 style={{ fontSize: 'large', marginTop: '0' }}>dorm deals - Nigeria’s Top Online Shopping Destination for Students</h1>
                </header>

                <section style={sectionStyle}>
                    <h2 style={h2Style}>Find Everything You Need with dorm deals</h2>
                    <p style={{fontSize: 'small'}}>dorm deals is the ultimate online shopping platform for Nigerian students living on campus. We provide a convenient way for students to shop for all their essentials from one place, whether you're in your dorm or taking a study break. On the dorm deals website or mobile app, you can effortlessly shop for <b><u>fashion</u></b>, <b><u>electronics</u></b>, <b><u>textbooks</u></b>, <b><u>groceries</u></b>, and more, all from the comfort of your campus accommodation.</p>
                    
                    <h2 style={h2Style}>Get the Best Deals on Quality Items</h2>
                    <p style={{fontSize: 'small'}}>At dorm deals, we take pride in offering the best prices and highest quality products available. Our partnerships with popular brands and suppliers ensure that students get genuine products at affordable rates. Whether it's the <b><u>latest gadgets</u></b>, <b><u>trendy clothing</u></b>, or <b><u>essential study materials</u></b>, dorm deals has you covered.</p>
                    ...
                    <p style={{fontSize: 'small'}}>dorm deals also offers a range of beauty products from trusted brands. Shop for skincare, makeup, and personal care items to help you look and feel your best. Our products are curated to ensure quality and authenticity, so you can shop with confidence.</p>
                    ...
                    <p style={{fontSize: 'small'}}>Stay connected and productive with the latest electronics and gadgets. Whether you need a new laptop, smartphone, or accessories like headphones and chargers, dorm deals offers competitive prices on top brands. Shop for tech gear that supports your academic and social life.</p>

                    <h2 style={h2Style}>Enjoy Exclusive Offers and Discounts</h2>
                    <p style={{fontSize: 'small'}}>Take advantage of fantastic deals and discounts available exclusively on dorm deals. From flash sales and seasonal offers to special student discounts, we provide numerous ways for you to save money on your purchases. Keep an eye out for our ongoing promotions to get the best value.</p>

                    <h2 style={h2Style}>Fast Delivery and Student-Friendly Service</h2>
                    <p style={{fontSize: 'small'}}>dorm deals ensures quick delivery to campuses across Nigeria. For items with our express tag, you can expect your order to arrive within 24 hours. We also offer flexible delivery options to fit your schedule and needs.</p>
                </section>

                <section style={faqsStyle}>
                    <h2 style={{ fontSize: 'large', marginTop: '0' }}>Frequently Asked Questions (FAQs)</h2>
                    <br />
                    <h3 style={{ color: '#000', fontSize: 'small', fontWeight: '600' }}>What Payment Options are Available on dorm deals?</h3>
                    <p style={{fontSize: 'small'}}>You can pay online or choose cash on delivery with dorm deals. We accept various payment methods including cards (MasterCard, Visa, and Verve), bank transfers, and mobile payments.</p>

                    <h3 style={{ color: '#000', fontSize: 'small', fontWeight: '600' }}>Can I Return Items Purchased from dorm deals?</h3>
                    ...
                    <h3 style={{ color: '#000', fontSize: 'small', fontWeight: '600' }}>How Can I Contact dorm deals Customer Service?</h3>
                    <p style={{fontSize: 'small'}}>For any inquiries or support, reach out to our customer service team at [Customer Care Number]. You can also chat with us through the dorm deals app for a more convenient experience.</p>

                    <h3 style={{ color: '#000', fontSize: 'small', fontWeight: '600' }}>How Can I Become a Seller on dorm deals?</h3>
                    <p style={{fontSize: 'small'}}>Students and vendors can partner with dorm deals to sell their products. Register with us and benefit from our extensive student customer base to reach more buyers.</p>

                    <h3 style={{ color: '#000', fontSize: 'small', fontWeight: '600' }}>What Other Events Does dorm deals Host?</h3>
