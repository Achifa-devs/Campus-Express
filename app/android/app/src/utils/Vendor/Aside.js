                ...
                <View style={{
                    ...
                    <View>
                        ...
                        <ScrollView style={{padding: 20}}>
                            ...
                            <TouchableOpacity style={{ marginBottom: 35, display: 'flex', flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'flex-start' }} onPress={e=> navigation.navigate('user-report')}>
                                <View>
                             ...
                             <TouchableOpacity style={{ marginBottom: 35, display: 'flex', flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'flex-start' }} onPress={e=> navigation.navigate('user-report')}>
                                ...
                                <Text style={{fontWeight: '500', fontSize: 14, color: '#000', marginLeft: 8}}>Balance</Text>
                            </TouchableOpacity>
                            ...
                            <TouchableOpacity style={{ marginBottom: 35, display: 'flex', flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'flex-start' }} onPress={e=> navigation.navigate('user-preference')}>
                                <View>
                            ...
                            <TouchableOpacity style={{ marginBottom: 35, display: 'flex', flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'flex-start' }} onPress={e=> Alert.alert("Check back later")}>
                                <View>
