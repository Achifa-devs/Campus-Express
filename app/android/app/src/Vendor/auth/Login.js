...
const Login = ({}) => {
    ...
    let loginHandler = async() => {
        ...
        if (data) {
            ...
            fetch('http://192.168.224.146:9090/vendor/login', {
                method: 'post',
                headers: {
            ...
            .then(async(result) => {
                ...
                if (response.success) {
                    console.log(response)
                    setUserId(response.data.seller_id)
                    ...
                    .then((done) => {
                        ...
                        storeData('email', response.data.email)
                        storeData('user', JSON.stringify(response.data)) 
                        storeData('user_id', response.data.seller_id)
