...
export default function Gender({updateGender}) {
  ...
  return (
    <>
      ...
      <View style={[styles.gender, {width: '100%'}]}>
        <Text style={{paddingLeft: 0, marginBottom: 8, color: '#000', fontSize: 14, fontWeight: '500'}}>Gender</Text>
        ...
        <View style={{width: '100%', marginBottom: 10}}>
            ...
            <TouchableOpacity keyboardAppearance='none' placeholder='Enter Product Condition Here' style={styles.input} multiline={true} onPress={e => {
                ...
                <Text style={{textAlign: 'left', width: '100%', color: '#000'}}>{selectedValue !== null ? list[parseInt(selectedValue)] : 'Select Gender'}</Text>
            </TouchableOpacity>
        </View> 
