...
export default function Size({updateSize,size_list}) {
  ...
  return (
    <>
      ...
      <View style={[styles.Size, {width: '100%'}]}>
        <Text style={{paddingLeft: 0, marginBottom: 8, color: '#000', fontSize: 14, fontWeight: '500'}}>Size</Text>
        
        <View style={{width: '100%', marginBottom: 10}}>
            {/* <TextInput placeholder='Enter Product Size Here' style={styles.input} multiline={true} verticalAlign='top' /> */}
            ...
            <TouchableOpacity keyboardAppearance='none' placeholder='Enter Product Condition Here' style={styles.input} multiline={true} onPress={e => {
                ...
                <Text style={{textAlign: 'left', width: '100%', color: '#000'}}>{selectedValue !== null ? list[parseInt(selectedValue)] : 'Select Size'}</Text>
            </TouchableOpacity>
        </View> 
