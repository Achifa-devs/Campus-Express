                ...
                <BottomModal visible={modalVisible} onClose={toggleModal}>
                    <ScrollView >
                        ...
                        <View style={{ height: 80, display: 'flex', color: '#000', width: '100%', flexDirection: 'column', marginBottom: 10}}>
                            ...
                            <Dropdown update_data={update_data} data={[{title: 'I do not accept refund'}, {title: 'I accept refund'}]} input_name={'state'} placeholder={'Select your state'} />
                        ...
                        <View style={{ height: 80, display: 'flex', color: '#000', width: '100%', flexDirection: 'column', marginBottom: 10}}>
                            ...
                            <Dropdown update_data={update_data} data={[{title: '1 day'}, {title: '2 days'}, {title: '3 days'}, {title: '4 days'}, {title: '5 days'}, {title: '6 days'}, {title: '1 week'}, {title: '2 weeks'}, {title: '3 weeks'}, {title: '1 month'}]} input_name={'state'} placeholder={'Select your state'} />
                            <Text style={{color: '#000', marginBottom: 15, display: stateErr.length > 0 ? 'flex' : 'none', fontSize: 10, paddingLeft: 5, color: 'red'}}>{stateErr}</Text>
                        </View> 
