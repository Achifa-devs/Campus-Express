                ...
                <ScrollView >
                   <View style={styles.inputCnt}>
                    ...
                    <View style={styles.inputCnt}>
                        ...
                        <TextInput style={styles.input} defaultValue={''} placeholder='Shop name' />
                    </View>
                    
                    <View style={styles.inputCnt}>
                        <Text style={styles.label}>Shop category</Text>
                        <TextInput style={styles.input} defaultValue={''} placeholder='Shop category' />
                    </View>
                    
                    <View style={styles.inputCnt}>
                        <Text style={styles.label}>Shop logo</Text>
                        <TextInput style={[styles.input]} multiline defaultValue={''} placeholder='Shop logo' />
                    </View>

                    <View style={styles.inputCnt}>
                        <Text style={styles.label}>Shop description</Text>
                        <TextInput style={[styles.input, {height: 170, alignItems: 'flex-start'}]} multiline defaultValue={''} textAlignVertical="top" placeholder='Shop description' />
                    </View>
