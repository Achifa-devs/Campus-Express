    ...
    return ( 
        <>
            ...
            <ScrollView style={{height: '100%', width: '100%',}}>
                ...
                {/* <TouchableOpacity onPress={e=> navigation.navigate('Payment')} style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: 10, marginBottom: 0, flexDirection: 'row', borderTopLeftRadius: 10, borderTopRightRadius: 10, height: 75, width: '100%', backgroundColor: '#fff'}}>
