...
export default function Shopile() {
    ...
    function get_shop_data() {
        fetch('https://estate-dun-eta.vercel.app/api/vendor/shop', {
            method: 'post',
            headers: {
                ...
                
                {
                    ...
                    <>
                        <View style={{display: 'flex', height: 60, color: '#000', width: '100%', flexDirection: 'column'}}>
                            ...
                            <TextInput 
 placeholderTextColor={"#333333"} style={{height: 50, padding: 10, fontFamily: 'serif', borderRadius: 5, marginBottom: 2, width: '100%',  backgroundColor: '#efefef'}} onChangeText={e => (e)}   placeholder="Shop name"  />
