...
// import UserSvg from '../../../media/assets/user-rounded-svgrepo-com (1).svg'
// import SupportSvg from '../../../media/assets/support-svgrepo-com (4).svg'
// import ReportSvg from '../../../media/assets/receipt-svgrepo-com.svg'
// import InviteSvg from '../../../media/assets/diptych-folded-paper-of-stationery-svgrepo-com.svg'
// import AngleSvg from '../../../media/assets/angle-right-svgrepo-com.svg'
// import LogoutSvg from '../../../media/assets/logout-svgrepo-com.svg'
// import HelpSvg from '../../../media/assets/help1-svgrepo-com.svg'
...
//             <View>
//                 <TouchableOpacity onPress={e => navigation.navigate('Legal')} style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottomLeftRadius: 10, borderBottomRightRadius: 10, padding: 20, marginBottom: 0, flexDirection: 'row', height: 75, width: '100%', backgroundColor: '#fff'}}>
//                     <View style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexDirection: 'row'}}>
...
//                 <Text style={{fontSize: 11, color: '#000', color: '#727272', textAlign: 'center', display: 'flex', justifyContent: 'center', fontWeight: 'bold', fontFamily: 'Roboto'}}>Campus Express   v-1.0.0</Text>
