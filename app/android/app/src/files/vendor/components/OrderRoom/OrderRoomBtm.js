        ...
        <View style={[styles.orderRoomBtm]}>
            <View>
                ...
                contentContainerStyle={{display: 'flex', alignItems: 'center', flexDirection: 'row', justifyContent: 'flex-start', flexWrap: 'no-wrap'}}>
                    <TouchableOpacity onPress={e => setActiveOpt(<Overview order={order}  product={product} />)}><Text style={{padding: 10, height: 'auto',fontSize: 16, fontWeight: '500' , color: '#fff', marginLeft: 2.5}}>Delivery info</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={e => setActiveOpt(<Payments order={order} product={product}  />)}><Text style={{padding: 10, height: 'auto',fontSize: 16, fontWeight: '500' , color: '#fff', marginLeft: 2.5}}>Payment info</Text>
                    </TouchableOpacity>
