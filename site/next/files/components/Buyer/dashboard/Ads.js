...
const Ads = () => {
    ...
    return (   
        <>
            <div className="buyer-ads-cnt shadow" style={{ background: '#fff', padding: screenWidth > 760 ? '10px' : '0', position: 'relative'}}>
                ...
                <section className="img-cnt" style={{width: screenWidth > 761 ? 'calc(100% - 280px)' : '100%', display: 'block', height: '100%', position: 'relative', borderRadius: '2.5px', padding: '0', margin: '0'}}>
                    <img src={ads.src} style={{borderRadius: '2.5px', margin: '0 0 0 -8px'}}  alt="" /> 
