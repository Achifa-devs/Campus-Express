...
const Aside = ({
    ...
    let list1 = [
        ...
        {uri: 'favourites',text: 'Favourites', img: savedSvg.src},  
        // {uri: '',text: 'History', img: historySvg.src},
        {uri: 'orders',text: 'Orders', img: sellSvg1.src}
    ]
    let list2 = [
        {uri: 'profile',text: 'My Account', img: userSvg.src},
        ...
        {uri: 'logout',text: buyerData?.fname ? 'Logout' : 'Login', img: buyerData?.fname ? logoutSvg.src : login.src}
    ]
