        ...
        <div className="buyer-product-reviews" style={{borderRadius: '5px', padding: '0'}}>
            ...
            <section >
                ...
                <div className='comments'>
                    <h6 style={{padding:'10px', margin: '0', height: '50px', width: '100%', background: '#fff', fontWeight: '600', display: 'flex', alignItems: 'center'}}>Comments From Verified Purchases</h6>
                    

                    <section style={{flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
                        <div style={{borderBottom: '1px solid #efefef', width: '100%', height: '170px', borderRadius: '0', padding: '10px'}}>
