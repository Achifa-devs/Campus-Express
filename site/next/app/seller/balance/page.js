"use client"
import '@/app/seller/balance/styles/xx-large.css'
import '@/app/seller/balance/styles/x-large.css'
import '@/app/seller/balance/styles/large.css'
import '@/app/seller/balance/styles/medium.css'
import '@/app/seller/balance/styles/small.css'
...
function OrdersList({updateSelectedOrder, cards}) {
  ...
  return(
    <>
      ...
      <hr />
      <div className='seller-balance-cnt'>
        <header>
          <ul style={{padding: '10px 0px', background: '#fff'}}>
          
            <li className='th-id'>S/N</li>
            <li className='th-src'>Source</li>
            <li className='th-price'>Amount</li>
            <li className='th-bf'>Balance Before</li>
            <li className='th-af'>Balance After</li>
            {/* <li className='th-action'>Details</li> */}
...
function OrderCard({item}) {
  return(
    <>
      <div className="new-balance-card-data">
        ...
        <div className="new-balance-card-data-cnt">
  ...
  return(
    <>
      <div className="new-balance-info">
        <div className="new-balance-info-cnt">
          <div className="left">
