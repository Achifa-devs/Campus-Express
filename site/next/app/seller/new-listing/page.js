...
import '@/app/seller/new-listing/styles/global.css'
...
export default function NewListing() {
    ...
    useEffect(() => {
        ...
        if (seller_id !== '' && seller_id !== undefined && seller_id !== 'undefined' && seller_id !== null && seller_id !== 'null') {
            if (is_update) {
                fetch(`https://ce-server.vercel.app/product?id[]=${product_id}`)
                .then(async(result) => {
    ...
    async function uploadProduct(product_id, seller_id, thumbnail_url) {
        let url = is_update ? 'https://ce-server.vercel.app/seller.product-update' : 'https://ce-server.vercel.app/seller.product-upload';
                                    ...
                                    ?
                                        <div style={{position: 'relative',height: '100%', width: '100%', border: '3px solid #FF4500'}}>
                                            <div onClick={e => { 
                                                ...
                                                axios.post('https://ce-server.vercel.app/seller.thumbnail-delete', {
