...
export async function POST(req) {
  try {
    ...
    const { acct_num,bank,beneficiary,user_id } = body;

    const res = await pool.query(`INSERT INTO payment(id,acct_num,bank,beneficiary,user_id,date) values(DEFAULT,'${acct_num}','${bank}','${beneficiary}','${user_id}','${new Date()}')`);
