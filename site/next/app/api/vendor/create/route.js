...
export async function POST(req) {
  try {
    ...
    const res = await pool.query(`INSERT INTO shopss(id,shop_id,user_id,title,category,status,description,logo_url,open_hrs,social_links,is_verified,created_at,updated_at) values(DEFAULT,'${shop_id}','${user_id}','${title}','','active','','','','',${false},'${new Date()}','${new Date()}')`);
