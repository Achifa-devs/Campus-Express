...
VENDOR_ROUTE.get('/admin', GET_VENDOR)
VENDOR_ROUTE.post('/admin/registration', parser, REGISTER_VENDOR)
VENDOR_ROUTE.post('/admin/login', parser, LOGIN_VENDOR)
VENDOR_ROUTE.post('/admin/email-update', parser, RESET_VENDOR_EMAIL )
VENDOR_ROUTE.post('/admin/phone-update', parser, RESET_VENDOR_PHONE)
VENDOR_ROUTE.post('/admin/profile-update', parser, UPDATE_VENDOR_PROFILE)
VENDOR_ROUTE.post('/admin/reset-password', parser, RESET_PWD)
