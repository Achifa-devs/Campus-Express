...
export async function GET_REFUNDS(req, res) {
    try {
        ...
        res.status(201).json({ success: true, data: refunds });
    } catch (error) {
        res.status(400).json({ success: false, message: error.message });
    }
}
...
export async function CREATE_REFUND(req, res) {
    try {
        ...
        res.status(201).json({ success: true, data: create_refund });
    } catch (error) {
        res.status(400).json({ success: false, message: error.message });
    }
}
...
export async function CANCEL_REFUND(req, res) {
    try {
        ...
        res.status(201).json({ success: true, data: cancel_refund });
    } catch (error) {
        res.status(400).json({ success: false, message: error.message });
    }
}
...
export async function CONFIRM_REFUND(req, res) {
    try {
        ...
        res.status(201).json({ success: true, data: confirm_refund });
    } catch (error) {
        res.status(400).json({ success: false, message: error.message });
    }
}
...
export async function REMOVE_REFUND(req, res) {
    try {
        ...
        res.status(201).json({ success: true, data: remove_refund });
    } catch (error) {
        res.status(400).json({ success: false, message: error.message });
    }
}
