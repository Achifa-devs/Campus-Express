                    ...
                    <div className="">
                        <article className="modal-container" style={{width: '100%', borderRadius: '5px'}}>
                            ...
                            <footer className="modal-container-footer">
                                <button className="button is-ghost" onClick={e=> {
                ...
                <div className="checkout-confirmation-cnt" >
                    ...
                    <div style={{
                        ...
                        <button style={{cursor: 'pointer', height: 'auto', width: 'fit-content', borderRadius: '5px'}} onClick={e => updateJsx(false)}>
                            <small style={{float: "left", borderBottom: activeJsx ? 'none': '1px solid #FFA500'}}>Track Your Order</small>
                        ...
                        <button style={{cursor: 'pointer', height: 'auto', width: 'fit-content', borderRadius: '5px'}} onClick={e => updateJsx(true)}>
                            <small style={{float: "left", borderBottom: !activeJsx ? 'none': '1px solid #FFA500'}}>Order Details</small>
                            {/* <small style={{float: "right"}}>View</small> */}
                        </button>
                    </div>
