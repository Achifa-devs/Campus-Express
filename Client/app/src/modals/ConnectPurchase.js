...
import { set_connect_purchase_modal } from '../../redux/modal/connect_purchase.js';
import Memory from '../utils/memoryHandler.js';

const ConnectionPurchase = ({ visible, onClose }) => {
  ...
  const getConnectPlan = async () => {
    try {
      let data = await Memory.get('connect_plan');
...
export default ConnectionPurchase;
