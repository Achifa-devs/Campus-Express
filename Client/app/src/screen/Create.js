...
import Category from '../components/Create/Category.js';
import Price from '../components/Create/Price.js';
import Stock from '../components/Create/Stock.js';
import Condition from '../components/Create/Condition.js';  
import items from '../json/product.json';
import lodge from '../json/accomodation.json';
import service from '../json/services.json';
import Photo from '../components/Create/Photo.js';
import SubCategory from '../components/Create/SubCategory.js';
import Gender from '../components/Create/Gender.js';
import Size from '../components/Create/Size.js';
import Title from '../components/Create/Title.js';
import Description from '../components/Create/Description.js';
import Type from '../components/Create/Type.js';
import UploadBtn from '../components/Create/UploadBtn.js';
import Address1 from '../components/Create/Address1.js';
import Address2 from '../components/Create/Address2.js';
import DeliveryRangeSelector from '../components/Create/Delivery.js';
import ShippingPolicy from '../components/Create/ShippingPolicy.js';
import ShippingDuration from '../components/Create/ShippingDuration.js';
import { useNavigation } from '@react-navigation/native';
import Features from '../components/Create/Amenities.js';
import Video from '../components/Create/Video.js';
import Freq from '../components/Create/Frequency.js';
import UpfrontPay from '../components/Create/UpfrontPayment.js';
...
export default function Create({ route }) {
  ...
  useEffect(() => {
    ...
    (async function getUser(params) {
      let user = await Memory.get('user');
      const id = (user)
      setUser(id)
    })()
  }, []);
  ...
  useEffect(() => {
    ...
    if (update) {
      ...
      setProductId(Tools.generateId(12))
    }
  }, [route])
  ...
  function uploadData() {
    ...
    if (response) {
      ...
      fetch('http://10.81.21.3:9090/vendor/create-product', {
        method: 'post',
        headers: {
